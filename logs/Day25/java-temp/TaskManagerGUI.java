...
class TaskCellRenderer extends DefaultListCellRenderer {
    private final Icon completedIcon = UIManager.getIcon("FileView.fileIcon");
    private final Icon pendingIcon = UIManager.getIcon("FileView.directoryIcon");
    ...
    public Component getListCellRendererComponent(JList<?> list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
        ...
        label.setIcon(task.isCompleted() ? completedIcon : pendingIcon);
